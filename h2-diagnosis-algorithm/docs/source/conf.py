...
# h2_diagnosis_algorithm documentation build
...
from h2_diagnosis_algorithm import __version__ as release

# -- Project information -----------------------------------------------------

project = "h2_diagnosis_algorithm"
author = "Kedro"
...
htmlhelp_basename = "h2_diagnosis_algorithmdoc"
...
latex_documents = [
    (
        master_doc,
        "h2_diagnosis_algorithm.tex",
        "h2_diagnosis_algorithm Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "h2_diagnosis_algorithm",
        "Project h2_diagnosis_algorithm codebase.",
        "Data-Science",
    )
]
