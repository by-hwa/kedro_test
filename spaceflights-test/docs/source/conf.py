...
# spaceflights_test documentation build
...
from spaceflights_test import __version__ as release

# -- Project information -----------------------------------------------------

project = "spaceflights_test"
author = "Kedro"
...
htmlhelp_basename = "spaceflights_testdoc"
...
latex_documents = [
    (
        master_doc,
        "spaceflights_test.tex",
        "spaceflights_test Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "spaceflights_test",
        "Project spaceflights_test codebase.",
        "Data-Science",
    )
]
